...
public class TokenRevocationService {
    ...
    public void revokeAccessToken(){
        String authorization = tokenHeaderProvider.getAccessToken().orElseThrow(IllegalStateException::new);
    ...
    public void revokeRefreshToken(){
        String refreshToken = tokenHeaderProvider.getRefreshToken().orElseThrow(TokenVerificationException::new);
